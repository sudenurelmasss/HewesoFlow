...
namespace HewesoFlow.Persistence.Migrations
{
    ...
    [Migration("20260812081820_AddProjectMessagingAndManager")]
    partial class AddProjectMessagingAndManager
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HewesoFlow.Domain.Entities.TaskAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("HewesoFlow.Domain.Entities.TaskAttachment", b =>
                {
                    ...
                    b.HasOne("HewesoFlow.Domain.Entities.User", "UploadedByUser")
                        .WithMany()
